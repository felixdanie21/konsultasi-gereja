        ...
        <div class="container-fluid">
            <div class="row">
                                        ...
                                        <?php foreach($mberita as $mb):?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="<?= base_url() ?>Beranda/berita/<?= $mb['beritaid'] ?>">Selengkapnya <i class="fas fa-chevron-right"></i></a>
                                                </td>
                                            </tr>
                                        <?php endforeach;?>
                                    </tbody>
                ...
                <div class="col-sm-6 order-md-2 order-1">
                    ...
                    <div class="card">
                        <div class="card-body p-2">
                            <form action="<?= base_url() ?>Beranda/komentar_post" method="post">
                                <input type="text" name="userkomentar" id="userkomentar" class="form-control mb-1" maxlength="30" placeholder="Nama Anda" required>
                            ...
                            <?php if($mkomentar):?>
                                ...
                                <?php foreach($mkomentar as $k):?>
                                    ...
                                    <div class="post col-12">
                                        ...
                                        <?php endif;?>
                                        <!-- balas komentar -->
                                        <form action="<?= base_url() ?>Beranda/komentar_reply/<?= $k['idkomentar'] ?>" method="post">
                                            <input type="hidden" name="tagkomentar" id="tagtextreply<?= $k['idkomentar'] ?>">
                                            <input style="display:none" name="userkomentar" id="namatextreply<?= $k['idkomentar'] ?>" class="form-control form-control-sm mt-3 mb-1" type="text" placeholder="Nama Anda" required>
